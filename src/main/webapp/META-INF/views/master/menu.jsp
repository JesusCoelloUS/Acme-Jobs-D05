...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.administrator" access="hasRole('Administrator')">
			<acme:menu-suboption code="master.menu.administrator.user-accounts" action="/administrator/user-account/list"/>
      		...
      		<acme:menu-suboption code="master.menu.administrator.announcement.list.administrator" action="/administrator/announcement/list"/>
    ...
    <!-- ---------------------------------------------------------------------------------------------------------------------------------------------- -->
		...
		<acme:menu-option code="master.menu.auditor" access="hasRole('Auditor')">
			...
			<acme:menu-suboption code="master.menu.auditor.job.list.others" action="/auditor/job/list-others"/>
			<acme:menu-suboption code="master.menu.auditor.audit-record.list" action="/auditor/audit-record/list"/>
		</acme:menu-option>
